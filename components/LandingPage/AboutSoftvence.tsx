    ...
    return (
        <div className='lg:py-[96px] md:py-[60px] py-10 md:max-w-[896px] mx-auto'>
            <div className='mx-auto flex flex-col items-center gap-4 p-[10px]'>
                <h2 className='text-[#17171C] text-2xl md:text-[32px] lg:text-[36px] font-bold leading-[111%] tracking-[-0.9px]'>About  <span className="bg-[linear-gradient(102deg,#7C3BED_0%,#A936E2_100%)] bg-clip-text text-transparent">
                    Softvence
                </span></h2>
